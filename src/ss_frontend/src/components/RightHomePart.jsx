  ...
  return (
    <div className='w-[25vw]  flex flex-col gap-6 '>
        <div className='flex flex-col gap-6 p-5 border-gray-200 border rounded-xl'>
            <p className='text-4xl font-medium'>Categories</p>
            <hr />
            <div className='flex flex-col gap-4'>
                <div className='  h-20'>
                    <p className='text-2xl font-medium'>Art</p>
                    <p className='text-lg text-gray-400'>17k posts</p>
                </div>
                <div className=' h-20'>
                    <p className='text-2xl font-medium'>Application</p>
                    <p className='text-lg text-gray-400'>17k posts</p>
                </div>
                <div className='  h-20'>
        ...
        <div className='flex flex-col gap-6 p-5 border-gray-200 border rounded-xl'>
            <p className='text-4xl font-medium'>Shining Creators</p>
            <hr />
            <div className='flex flex-col gap-4'>
